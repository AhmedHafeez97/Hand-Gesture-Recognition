    ...
    try:  # an error comes if it does not find anything in window as it cannot find contour of max area
        ...
        if l == 1:
            if areacnt < 2000:
                ...
                cv2.putText(image, 'Punch', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
                print(arearatio)
            elif arearatio > 6:
                cv2.putText(image, 'Hello', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
                print(arearatio)

        elif l == 2:
            cv2.putText(image, 'Move', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
            print(arearatio)

        elif l == 5:
            #if arearatio < 29:
                cv2.putText(image, 'Stop', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
                print(arearatio)
        else:
